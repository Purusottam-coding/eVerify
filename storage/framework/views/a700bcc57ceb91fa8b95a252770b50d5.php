<?php $__env->startSection('title', 'ई-भेरिफाइ | सरकारी कागजात प्रमाणीकरण प्रणाली'); ?>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-light px-4">
                                <i class="bi bi-speedometer2"></i> ड्यासबोर्ड
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light px-4">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <div class="d-flex justify-content-center flex-wrap gap-3">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-gov-primary px-4">
                        <i class="bi bi-speedometer2"></i> ड्यासबोर्ड जानुहोस्
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-gov-primary px-4">
                        <i class="bi bi-box-arrow-in-right"></i> लगइन गर्नुहोस्
                    </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\everify\resources\views\home.blade.php ENDPATH**/ ?>