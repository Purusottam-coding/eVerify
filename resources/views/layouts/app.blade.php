...
<head>
    ...
    <title>@yield('title', 'ई-भेरिफाइ | सरकारी कागजात प्रमाणीकरण प्रणाली')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <div class="d-flex gap-2 align-items-center">
                    @auth
                        <span class="badge bg-secondary">{{ auth()->user()->roleLabel() }}</span>
                        @if(auth()->user()->isSuperAdmin())
                            <a href="{{ route('users.create') }}" class="btn btn-gov-outline btn-sm px-3">
                                <i class="bi bi-person-plus"></i> प्रयोगकर्ता थप्नुहोस्
                            </a>
                        @endif
                        <a href="{{ route('dashboard') }}" class="btn btn-gov-outline btn-sm px-3">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-gov-primary btn-sm px-3">लगइन</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <footer class="footer-gov" id="contact">
        <div class="container">
            ...
            <div class="footer-bottom">
                &copy; {{ date('Y') }} ई-भेरिफाइ। सर्वाधिकार सुरक्षित। | Government Document Verification System
            </div>
        </div>
    </footer>
